...
public class HistorialFragment extends Fragment implements ReletedItemDaynamicAdp.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        itemAdp = new ReletedItemDaynamicAdp(getContext(), dynamicDataList.get(0).getDynamicItems(), this);
